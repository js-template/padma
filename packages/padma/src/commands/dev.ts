...
export default class Dev extends Command {
  ...
  public async run(): Promise<void> {
    ...
    const settingsPath = fs.existsSync(path.resolve(process.cwd(), 'padma.settings.js'))
      ? path.resolve(process.cwd(), 'padma.settings.js')
      : path.resolve(process.cwd(), 'padma.settings.ts')
