      ...
      <Paper
         ...
         <Grid container direction='column' justifyContent='center' spacing={2}>
            <Grid item xs={12} container alignItems='center' justifyContent='center'>
               <Box sx={{ mb: 2 }}>
                  <Typography fontSize={24} fontWeight={400} color={(theme) => theme.palette.text.primary}>
               ...
               <Box
                  ...
                  <Button
                     ...
                     sx={{
                        ...
                        // disable color
                        "&.Mui-disabled": {
                           borderColor: (theme) => hexToRGBA(theme.palette.text.disabled, 0.4) + "!important",
                           color: (theme) => hexToRGBA(theme.palette.text.disabled, 0.4) + "!important"
                        }
                     }}
                     disableRipple
                     disabled>
                  ...
                  <Divider
                     sx={{ flexGrow: 1, borderColor: (theme) => hexToRGBA(theme.palette.text.disabled, 0.4) }}
                     orientation='horizontal'
                  />
               </Box>
            </Grid>
