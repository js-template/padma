...
type JobAttributes = {
   ...
   deadline: string // Consider using Date if you want to work with Date objects
   salary: string // You might want to use number if you plan to perform arithmetic operations
   location: Location
